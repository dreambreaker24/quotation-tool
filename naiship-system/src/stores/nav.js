...
export const useNavStore = defineStore('nav', () => {
    const pendingJump = ref(null)     // { caseId, caseTab, companyId }
    const pendingPhotoType = ref('')  // photo category key to auto-expand

    function requestCaseJump(caseId, caseTab, companyId, photoType = '') {
        pendingPhotoType.value = photoType
        pendingJump.value = { caseId, caseTab, companyId }
    }
