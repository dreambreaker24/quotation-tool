    ...
    async function addRevenueLog({ date, items, paymentMethod, note, recordedBy, recordedByUid }) {
        ...
        return runTransaction(db, async (transaction) => {
            ...
            for (const { drinkId } of bottleNeeds) {
                ...
                batchesByDrink[drinkId] = batchSnaps
